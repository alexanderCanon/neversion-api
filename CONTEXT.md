# MASTER PROMPT – CONTEXTO DEL NEGOCIO

## General Description
I want you to understand my business before giving me any recommendations.
...
My business model is manual. The customer enters, chooses one or several services, makes payment by bank transfer, and then sends me the receipt. I manually check if the payment is correct and then send the accesses via WhatsApp or email.
...
- I buy accounts from providers. Some accounts are:
    ...
    - Family (I can sell the same accesses to multiple people if it's by profile).
