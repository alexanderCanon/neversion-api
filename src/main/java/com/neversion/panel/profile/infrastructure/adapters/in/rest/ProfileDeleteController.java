...
// import
// com.neversion.panel.profile.application.port.in.DeactivateProfileUseCase;
...
// public ProfileDeleteController(DeactivateProfileUseCase
// deactivateProfileUseCase) {
// this.deactivateProfileUseCase = deactivateProfileUseCase;
// }

// @DeleteMapping("/{id}")
// @Operation(summary = "Deactivate a profile", description = "Soft-delete a
// profile by its UUID")
// @ApiResponse(responseCode = "204", description = "Profile deactivated
// successfully")
